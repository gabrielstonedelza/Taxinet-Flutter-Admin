...
class UpdateVehicle extends StatefulWidget {
  ...
  String vin;
  String body_number;
  String registration_certificate_number;
  String taxi_license_number;
  String transmission;
  String vboosters;
  String child_safety_seats;
  String code_name;
  String category;
  String model;
  String id;
  UpdateVehicle({Key? key,required this.status,required this.brand,required this.color,required this.year,required this.license_plate_number,required this.vin,required this.body_number,required this.registration_certificate_number,required this.taxi_license_number,required this.transmission,required this.vboosters,required this.child_safety_seats,required this.code_name,required this.category,required this.model,required this.id}) : super(key: key);

  @override
  State<UpdateVehicle> createState() => _UpdateVehicleState(status:this.status,brand:this.brand,color:this.color,year:this.year,license_plate_number:this.license_plate_number,vin:this.vin,body_number:this.body_number,registration_certificate_number:this.registration_certificate_number,taxi_license_number:this.taxi_license_number,transmission:this.transmission,vboosters:this.vboosters,child_safety_seats:this.child_safety_seats,code_name:this.code_name,category:this.category,model:this.model,id:this.id);
}
...
class _UpdateVehicleState extends State<UpdateVehicle> {
  ...
  String model;
  String id;
  _UpdateVehicleState({required this.status,required this.brand,required this.color,required this.year,required this.license_plate_number,required this.vin,required this.body_number,required this.registration_certificate_number,required this.taxi_license_number,required this.transmission,required this.vboosters,required this.child_safety_seats,required this.code_name,required this.category,required this.model,required this.id});
  ...
  String currentSelectedBrand = "";
  String currentSelectedColor = "";
  String currentSelectedTransmission = "";
  String currentSelectedBooster = "";
  String currentSelectedChildSafety = "";
  ...
  late final  TextEditingController licensePlateNumberController;
  ...
  late final  TextEditingController bodyNumberController;
  final FocusNode bodyNumberFocusNode = FocusNode();
  late final  TextEditingController regCertNumberController;
  final FocusNode regCertNumberFocusNode = FocusNode();
  late final  TextEditingController taxiLicenseNumberController;
  final FocusNode taxiLicenseNumberFocusNode = FocusNode();
  late final  TextEditingController codeNameController;
  ...
  updateRegisteredVehicle() async {
    final requestUrl = "https://taxinetghana.xyz/vehicle_update/$id/";
  ...
  void initState(){
    ...
    licensePlateNumberController = TextEditingController(text:license_plate_number);
    vinController = TextEditingController(text:vin);
    bodyNumberController = TextEditingController(text:body_number);
    regCertNumberController = TextEditingController(text:registration_certificate_number);
    taxiLicenseNumberController = TextEditingController(text:taxi_license_number);
    codeNameController = TextEditingController(text:code_name);
    currentSelectedStatus = status;
    currentSelectedBrand = brand;
    currentSelectedColor = color;
    currentSelectedTransmission = transmission;
    currentSelectedBooster = vboosters;
    currentSelectedCategory = category;
    currentSelectedChildSafety = child_safety_seats;
  }
